...
import Collage from '../images/logocollage.png';
...
const About = () => {
    ...
    const technologyBody = "Full-stack web developer specializing in React and providing fluid, front end user experience. Deep knowledge of design and user interface. Skilled in creating production level REST and GraphQL APIs. Accomplished at creating fully functional, secure eCommerce web sites. Certified AWS Cloud Practitioner with the ability to provision and manage both traditional and serverless cloud platforms. Experienced in Python, Django, and MTV Framework. Proficient in Photoshop."
